...
ampl   = interp1(rand(p,1)*30,linspace(1,p,n)); % 1-D data interpolation 
...
tidx = dsearchn(time',1);% Nearest point search to 1
ylim = get(gca,'ylim');
...
plot(time,signal,time,movmean(signal,k),'yellow','linew',2)
